...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { cost: @thing.cost, date: @thing.date, description: @thing.description, thing_name: @thing.thing_name }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { cost: @thing.cost, date: @thing.date, description: @thing.description, thing_name: @thing.thing_name }
    assert_redirected_to thing_path(assigns(:thing))
  end
